...
const mockOpenCodeGoModels = ["glm-5.3-flash", "glm-5.3", "glm-5.2", "glm-5.1", "kimi-k3", "kimi-k2.7-code", "kimi-k2.6", "deepseek-v4-pro", "deepseek-v4-flash", "mimo-v2.5-pro", "mimo-v2.5", "hy3"];
...
const mockProviderPresetTemplates: MockProviderPresetTemplate[] = [
  mockBundlePreset(
    ...
    "OPENCODE_GO_API_KEY",
    [
      mockProviderTemplate({ name: "opencode-go", kind: "openai", baseUrl: "https://opencode.ai/zen/go/v1", models: mockOpenCodeGoModels, visionModels: ["glm-5.3-flash", "kimi-k3"], default: "glm-5.3", apiKeyEnv: "OPENCODE_GO_API_KEY", contextWindow: 128000, modelOverrides: [{ model: "glm-5.3-flash", reasoningProtocol: "openai", supportedEfforts: ["low", "high", "max"], defaultEffort: "low", contextWindow: 1000000, maxOutputTokens: 131072 }, { model: "glm-5.3", reasoningProtocol: "openai", supportedEfforts: ["low", "high", "max"], defaultEffort: "low", maxOutputTokens: 32768 }, { model: "deepseek-v4-flash", reasoningProtocol: "deepseek", supportedEfforts: ["disabled", "low", "high", "max"], defaultEffort: "high", maxOutputTokens: 32768 }, { model: "deepseek-v4-pro", reasoningProtocol: "deepseek", supportedEfforts: ["disabled", "low", "high", "max"], defaultEffort: "high", maxOutputTokens: 32768 }, { model: "kimi-k3", reasoningProtocol: "openai", supportedEfforts: ["high", "max"], defaultEffort: "max", contextWindow: 1048576, maxOutputTokens: 32768 }] }),
  ...
  mockPreset("opencode-go", "OpenCode Go", "OpenCode Go relay with per-model capability overrides.", "OPENCODE_GO_API_KEY", mockProviderTemplate({ name: "opencode-go", kind: "openai", baseUrl: "https://opencode.ai/zen/go/v1", models: mockOpenCodeGoModels, visionModels: ["glm-5.3-flash", "kimi-k3"], default: "glm-5.2", apiKeyEnv: "OPENCODE_GO_API_KEY", contextWindow: 128000, modelOverrides: [{ model: "glm-5.3-flash", reasoningProtocol: "openai", supportedEfforts: ["low", "high", "max"], defaultEffort: "low", contextWindow: 1000000, maxOutputTokens: 131072 }, { model: "glm-5.3", reasoningProtocol: "openai", supportedEfforts: ["low", "high", "max"], defaultEffort: "high" }, { model: "glm-5.2", reasoningProtocol: "openai", supportedEfforts: ["high", "max"], defaultEffort: "high" }, { model: "deepseek-v4-flash", reasoningProtocol: "deepseek", supportedEfforts: ["disabled", "low", "high", "max"], defaultEffort: "high" }, { model: "deepseek-v4-pro", reasoningProtocol: "deepseek", supportedEfforts: ["disabled", "low", "high", "max"], defaultEffort: "high" }, { model: "kimi-k3", reasoningProtocol: "openai", supportedEfforts: ["high", "max"], defaultEffort: "max", contextWindow: 1048576 }, { model: "hy3", reasoningProtocol: "openai", supportedEfforts: ["none", "low", "high"], defaultEffort: "high" }] }), { displayGroup: "opencode", displaySection: "go", displayTier: "compatibility", routeKind: "chat", displayOrder: 90 }),
