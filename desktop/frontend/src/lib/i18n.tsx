...
export const SPINNER_WORDS: Record<Locale, string[]> = {
  ...
  zh: [
    "梳理思路", "聚焦问题", "拆解任务", "推演方案", "权衡取舍", "推敲细节",
    "整合结论", "评估进展", "校验结果", "检索资料", "构建方案",
    "验证逻辑", "总结要点", "打磨输出", "迭代优化", "排查障碍", "规划步骤",
    "分析上下文", "整理成果", "完善方案",
  ],
  "zh-TW": [
    "梳理思路", "聚焦問題", "拆解任務", "推演方案", "權衡取捨", "推敲細節",
    "整合結論", "評估進展", "校驗結果", "檢索資料", "構建方案",
    "驗證邏輯", "總結要點", "打磨輸出", "迭代優化", "排查障礙", "規劃步驟",
    "分析上下文", "整理成果", "完善方案",
  ],
};
