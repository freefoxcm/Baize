...
| --- | --- | --- |
| `analyze_data` | true | Run deterministic, side-effect-free Starlark calculations over JSON for grouping, aggregation, intersections, rankings, and trends without creating temporary files or accessing files, environment variables, time, randomness, network, modules, or subprocesses. |
