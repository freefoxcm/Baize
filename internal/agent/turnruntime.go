...
type terminalProtocolState struct {
	...
	// completeStepJSONRepairs counts the bounded repair for a complete_step
	// payload emitted as assistant text instead of a tool call.
	completeStepJSONRepairs int
