...
const (
	taskCommandUsage = "usage: baize task <list|show|monitor|status|events|stop|cancel|requeue|open-session|tmux> [flags]"
	taskMonitorUsage = "usage: baize task monitor <list|status|events|stop|cancel|requeue|open-session> [flags]"
	taskTmuxUsage    = "usage: baize task tmux <attach|status|open|detach>"
)
