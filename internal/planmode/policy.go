...
func (Policy) Decide(call Call) Decision {
	...
	if name == "complete_step" {
		return Decision{
			Blocked: true,
			Message: "Planning state unchanged: complete_step is only available after plan approval. While planning, update planning-item statuses with todo_write itself and present the plan for user approval.",
		}
	}
	return Decision{
		Blocked: true,
