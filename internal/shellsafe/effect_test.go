...
func TestClassifyBashCommandEffects(t *testing.T) {
	tests := []struct {
		...
		{name: "powershell date display", command: "Get-Date", certainty: EffectKnown, permission: true, family: "get-date"},
		{name: "powershell date format", command: `Get-Date -Format "yyyy-MM-dd"`, certainty: EffectKnown, permission: true, family: "get-date"},
		{name: "powershell date parse", command: `Get-Date -Date "2026-08-15"`, certainty: EffectKnown, permission: true, family: "get-date"},
		{name: "powershell date set fails closed", command: `Set-Date -Date "2026-08-15"`, certainty: EffectUnknown, family: "set-date"},
